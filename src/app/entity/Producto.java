...
public class Producto {
    ...
    public Producto(String nombreComercial, String nombreGenerico, String presentacion, String formula, String tipo, String control, String proveedor, double precio, int stock, int id_proveedor) {
